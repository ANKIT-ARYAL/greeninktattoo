  ...
  return (
    <section id="booking" className="py-24 text-white">
      <div className="max-w-7xl mx-auto px-8 mb-24">
        <h3 className="text-7xl font-blackops text-white uppercase mb-12">What Clients Say</h3>
        <ReviewSlider /> 
      </div>
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div className="space-y-12">
          <div>
            <h2 className="text-6xl md:text-7xl font-blackops uppercase mb-8">Let's Create <br />Something Permanent.</h2>
          ...
          <div className="space-y-6">
            {contactInfo.map((info, i) => (
              <div key={i} className="border border-white/10 rounded-2xl p-6 flex items-center gap-4 hover:border-white/30 transition-all">
                ...
                <div className='font-blackops'>
                  <p className="text-[10px] uppercase tracking-widest text-white/50">{info.title}</p>
                  <p className="text-sm tracking-widest">{info.value}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <h1 className='font-blackops text-3xl p-3 text-white' >Book an Appointment</h1>
          <BookingForm />
        </div>
      </div>
    </section>
