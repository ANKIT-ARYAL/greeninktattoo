  ...
  return (
    <div className="min-h-screen bg-black p-8 lg:p-12 space-y-10">
      ...
      <header className="flex justify-between items-end max-w-7xl mx-auto w-full">
        ...
        <div>
          {" "}
          <p className="text-[10px] font-black uppercase tracking-[0.4em] text-white mb-2">
            Gallery Control
          </p>{" "}
          <h1 className="text-4xl md:text-5xl font-display text-white uppercase tracking-widerer">
            Portfolio Manager
          </h1>{" "}
        </div>{" "}
        <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 max-w-7xl mx-auto">
          ...
          {designs.map((design) => {
            ...
            return (
              <div
                key={design.id}
                className="group bg-neutral-900 border border-white/5 rounded-[2.5rem] overflow-hidden hover:border-white/20 transition-all duration-500"
              >
                {" "}
                ...
                <div className="p-7 flex justify-between items-center bg-neutral-900/50 backdrop-blur-md">
                  ...
                  <div className="min-w-0">
                    {" "}
                    <h3 className="text-white text-sm truncate uppercase tracking-widerer">
                      {design.title}
                    </h3>{" "}
                    <p className="text-[9px] text-white font-black uppercase tracking-[0.2em] mt-1.5">
                      {design.category}
                    </p>{" "}
                  </div>{" "}
                  <div className="flex gap-1">
                    ...
                    <button
                      ...
                      className={`p-3 transition-colors ${design.isFeatured ? "text-white" : "text-neutral-600 hover:text-white"}`}
                      title="Toggle Featured"
                    >
                      {" "}
                      <Star
                        size={18}
                        fill={design.isFeatured ? "currentColor" : "none"}
                      />{" "}
                    </button>{" "}
                    <button
