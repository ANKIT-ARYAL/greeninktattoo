      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
            <div className="bg-neutral-900 border border-white/10 p-8 rounded-[2.5rem] space-y-8">
              ...
              <div className="pt-8 border-t border-white/5 space-y-4">
                {/* WHATSAPP ACTION */}
                <a 
                  href={`https://wa.me/${booking.contactNumber.replace(/\D/g, '')}`} 
                  target="_blank"
                  className="flex items-center justify-center gap-3 w-full bg-white text-black py-5 rounded-2xl font-black uppercase text-[10px] tracking-widest hover:bg-emerald-500 transition-all active:scale-95"
                >
                  Message on WhatsApp <ExternalLink size={14} />
                </a>

                <button className="w-full bg-neutral-800 text-white py-5 rounded-2xl font-black uppercase text-[10px] tracking-widest hover:bg-red-500 transition-all">
                  Archive Inquiry
                </button>
              </div>
            </div>
